...
class LibTestCase(unittest.TestCase):
    ...
    def test_make_item(self):
        self.assertEqual({'data': 'a', 'title': 'b', 'subtitle': 'c', 'dummy': True}, make_item('a', 'b', 'c', dummy=True))
        self.assertEqual({'data': 'a', 'title': 'b', 'subtitle': 'c', 'dummy': False}, make_item('a', 'b', 'c'))
